...
def drawCube():
    ...
    for i in range(3):
        display.line(int(p2x[i]),   int(p2y[i]),   int(p2x[i+1]), int(p2y[i+1]), 1)
        display.line(int(p2x[i+4]), int(p2y[i+4]), int(p2x[i+5]), int(p2y[i+5]), 1)
        display.line(int(p2x[i]),   int(p2y[i]),   int(p2x[i+4]), int(p2y[i+4]), 1)

    display.line(int(p2x[3]), int(p2y[3]), int(p2x[0]), int(p2y[0]), 1)
    display.line(int(p2x[7]), int(p2y[7]), int(p2x[4]), int(p2y[4]), 1)
    display.line(int(p2x[3]), int(p2y[3]), int(p2x[7]), int(p2y[7]), 1)
    display.show()
